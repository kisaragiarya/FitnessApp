...
public class tangantangan extends AppCompatActivity implements AdapterView.OnItemClickListener {
    private ListView lv;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tangantangan);
        wodList = DataHelper.loadWorkout1( this);
